        ...
        <div class="absolute top-2 rounded left-5 z-20">
            <div :class="{'h-[85vh]': sidebar, 'h-full': !sidebar}" class=" w-96   bg-white bg-opacity-50 py-6 shadow-lg shadow-r select-none overflow-y-auto scrollbar-hide rounded-lg">
                ...
                <div class="relative " x-show="sidebar">
                    <div class=" overflow-x-auto scrollbar-hide  justify-between px-4 flex   mt-6 border-b border-gray-300 z-30">
                        <a class="whitespace-nowrap text-xs font-medium uppercase py-1 border-b-2 border-b-red-500">peta</a>
                        <a href="{{ route('beranda') }}" class="whitespace-nowrap text-xs font-medium uppercase cursor-pointer py-1">beranda</a>
                        <a href="{{ route('about') }}" class="whitespace-nowrap text-xs font-medium uppercase cursor-pointer py-1">tentang</a>
                        <a href="{{ route('profile') }}" class="whitespace-nowrap text-xs font-medium uppercase cursor-pointer py-1">profil</a>
                        <a href="{{ route('updates') }}" class="whitespace-nowrap text-xs font-medium uppercase cursor-pointer py-1">informasi</a>
                    </div>
            ...
            <div class=" bottom-0  flex justify-center ">
                <div class="rounded-lg px-6 absolute -mt-4 z-30  bg-gray-500 bg-opacity-90 text-center" @click="sidebar=!sidebar">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20" stroke-width="0.1" stroke="none"  :class="{'rotate-180': sidebar, 'rotate-0': !sidebar}" class=" w-9 h-9 text-white transition-transform duration-200 transform "><path fill-rule="evenodd" d="M5.22 8.22a.75.75 0 0 1 1.06 0L10 11.94l3.72-3.72a.75.75 0 1 1 1.06 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L5.22 9.28a.75.75 0 0 1 0-1.06Z" clip-rule="evenodd" /></svg>
                </div>
            </div>
