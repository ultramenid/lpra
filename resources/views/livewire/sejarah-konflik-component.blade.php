<div class="px-2">
    ...
    <div class="flex  gap-4  mb-6">
        <h1 class="sm:text-3xl text-xl text-newgray-900 dark:text-newgray-300 font-semibold ">Sejarah konflik</h1>
        <a class="sm:text-3xl text-xl font-semibold">{{$sejarahkonflik}} / {{$totalprofil}}</a>
    </div>
